...
public class Practise {
	...
	public static void main(String[] args) throws ParseException {
		...
		boolean status = getValueFromMaps(StateWiseCityData);
		
		
		Gson gson = new Gson();
		String jsonInString = gson.toJson(StateWiseCityData);
		String fileNamePath ="/home/deep/Desktop/";
		Scanner sc=new Scanner(System.in);
		String fileNames=sc.nextLine();
		
		stringToFile(jsonInString,fileNamePath+fileNames);
	...
	private static boolean getValueFromMaps(Map<String, Map<String, Map<String, Map<String, Map<Date, List<WeatherData>>>>>> StateWiseCityData)
	{
		return false;
		
	}
	
	private static void stringToFile(String inpuString, String fileName )
	{
		try {
